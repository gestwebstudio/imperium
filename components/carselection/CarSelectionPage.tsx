...
const STEPS = [
  {
    ...
    text: "Расскажите, какой автомобиль вам нужен. Менеджер уточняет марку, модель, комплектацию, бюджет и особые пожелания.",
  },
  {
    stage: "Этап 2",
...
const CONDITIONS = [
  "Редкие комплектации вне массового рынка",
  "Один менеджер на всю сделку",
  "Проверка до покупки, защита интересов",
  "Регистрация, страхование, помощь после выдачи",
  "Прозрачная история авто и фиксированные сроки",
];
  ...
  return (
    <main className="trade-in car-selection">
      ...
      <section className="home-wrap ti-factors ti-cs-2">
        ...
        <div className="ti-block__body ti-factors__body">
          <h2 className="ti-block__title">
            <span className="reg">Почему клиенты</span>
            <span className="bold">выбирают Imperium Motors</span>
          </h2>
          <ul className="ti-list">
            {CONDITIONS.map((c) => (
              <li key={c}>{c}</li>
