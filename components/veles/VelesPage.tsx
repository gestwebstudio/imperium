      ...
      <section className="home-wrap veles-identity">
        <div className="about__identity">
          ...
          <ServiceImageCard
            ...
            text="Эскиз разрабатывается с нуля под ваш автомобиль. Без повторов и шаблонов — только ваша идея."
            modal={{
              description:
          ...
          <ServiceImageCard
            ...
            title="Оклейка и смена цвета"
            image="/images/services/veles4.webp"
            text="Оклейка премиальной пленкой — эксклюзивные оттенки и фактуры. Меняем характер автомобиля без покраски"
            modal={{
              description:
